...
<model ref="r:a1d4a043-3260-4678-bdb1-f32efab91199(Basics.HelloWorld)">
  ...
  <node concept="314ZVc" id="64QC5GX0dsT">
    ...
    <node concept="314ZUh" id="64QC5GX0dsU" role="314ZU9">
      ...
      <node concept="314SfX" id="7T2YScNRNU2" role="314ZPE">
        <node concept="314Se_" id="7T2YScNRNVd" role="314SfY">
          <ref role="314SeG" to="67es:At5JuHK86n" resolve="out_string" />
          <node concept="314ZOx" id="7T2YScNRNWy" role="314SeD">
            <property role="314ZO_" value="Hello World!" />
          </node>
        </node>
      </node>
    </node>
    <node concept="2d$Iqm" id="7T2YScNZkXs" role="2KNzGL">
